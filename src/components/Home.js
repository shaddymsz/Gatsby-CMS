        ...
        <Layout>
            <div className="container-fluid">
                <section className="hero-widget">
                    <h1 className="hero-widget__header font-mw stashable">Best Policies at Lowest Premiums</h1>
                ...
                <div ><section className="cf-section cf-section--30" >
                    <div className="container">
                        <div className="row claimsassistance animate">
                            <div className="col-md-6">
                                <div className="cf-section__label space_mb_8" >RELIABLE</div>
                                <h3 className="cf-section__heading space_mb_16 line-height-reset" >Claims Assistance</h3>
          ...
          till the rightful judgement is passed. We are a bunch of humans who care for their customers a lot.
                                ...
                                <div className="video-thumbnail-testimonial">
                                    <div className="video-thumbnail-testimonial__title" >WHAT ARE PEOPLE SAYING</div>
                                    <hr></hr>
            ...
            "My first experience with XPcover was an absolute delight. Their
                ...
                <div ><section className="cf-section cf-section--26 cf-section--alter">
                    <div className="container">
                        <div className="row instantpayment animate" >
                            <div className="col-md-6">
                                <img alt="" className="rcla__img img-responsive"  loading="lazy" src="https://assets.coverfox.com/static/img/illustrates/data_security_illustrations.ccc8bcc5fc11.png" />
                            </div>
                            <div className="col-md-6">
                                <div className="cf-section__label space_mb_8" >SECURE</div>
                                <h3 className="cf-section__heading space_mb_16 line-height-reset" >Data Security <br/> Guaranteed</h3>
                                <div className="cf-section__info space_mb_24" >Your data is private and stored in govt. approved data centers. We don't sell it to anyone, nor will we ever share it without your consent. </div>
                                <ul className="rcla__features-list" ><li>Data stored in ISO certified data centers only.</li>
                ...
                <div ><section className="nap-and-exclaim space_mb_24 space_mt_60" >
                    <div className="container">
                        <div className="cf-section__label text-center" >
      JUST FOR YOU
                        </div>
                                    ...
                                    <div className="saf-fb">
                                        ...
                                        <div className="saf-fb__heading">
                                            <div className="saf-fb__heading__icon">
                                                <img alt="3-Day Express Claims Service"  loading="lazy" src="https://assets.coverfox.com/static/img/icons/ic_expres-claims.d26f8c8d8f34.svg" />
                                            </div>
                                            <div className="saf-fb__heading__text">
                                                <div className="saf-fb__heading__text__title" >3-Day Express Claims Service</div>
                                                <div className="saf-fb__heading__text__subtitle" >For Car Insurance Customers</div>
                                            </div>
                                        </div>
                                        <div className="saf-fb__features">
                                            <div className="saf-fb__features__title" >FEATURES :</div>
                                            <ul className="saf-fb__features__list" ><li>We service your claim in 3 day or less</li>
                                                <li>We pick your car, get it repaired &amp; drop it back</li>
                                                <li>Repairs, paper-work &amp; payments - we do it all</li></ul>
                                        </div>
                                    </div>
                                    <div className="saf-content__note"> Available for cars registered in major cities.</div>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="saf-content saf-content--yellow">
                                    <div className="saf-content__right">
                                        <div className="saf-fb">
                                            ...
                                            <div className="saf-fb__heading">
                                                <div className="saf-fb__heading__icon">
                                                    <img alt="Nominee Assistance Program"  loading="lazy" src="https://assets.coverfox.com/static/img/icons/ic_nap.afdd630d5afa.svg" />
                                                </div>
                                                <div className="saf-fb__heading__text">
                                                    <div className="saf-fb__heading__text__title" >Nominee Assistance Program</div>
                                                    <div className="saf-fb__heading__text__subtitle" >For XPcover Life Insurance Customers</div>
                                                </div>
                                            </div>
                                            <div className="saf-fb__features">
                                                <div className="saf-fb__features__title" >FEATURES :</div>
                                                <ul className="saf-fb__features__list" ><li>We ensure your nominee gets the rightful claim</li>
                ...
                <div>
                    <section className="cf-section cf-section--alter cf-section--20">
                        <div className="container">
                            ...
                            <div className="cf-section__heading cf-section__heading--20 text-center" > Ask us anything, we’d love to answer!</div>
                            <div ><div ><div className="cf-faq__item dynamic-accordian">
                                <div className="cf-faq__icon"></div>
                                <div className="cf-faq__question" ><p>How is XPcover different from other insurance marketplaces?</p>
                                </div>
                                <div className="cf-faq__answer" ><p>"We, at XPcover, aspire to be your one-stop-shop, your go to place ever for anything related to insurance. This means:</p>
                                    <ol>
                            ...
                            <div ><div className="cf-faq__item dynamic-accordian">
                                <div className="cf-faq__icon"></div>
                                <div className="cf-faq__question" ><p>How does XPcover make money?</p>
                                </div>
                            ...
                            <div ><div className="cf-faq__item dynamic-accordian">
                                <div className="cf-faq__icon"></div>
                                <div className="cf-faq__question" ><p>Is it cheaper to buy insurance through XPcover.com?</p>
                                </div>
                                <div className="cf-faq__answer" ><p>Insurance is a regulated market. No insurance company, neither XPcover nor any other agent can give you a deal cheaper than what the insurance company has set. It is illegal to do so. The best way to save money on insurance premiums is by comparing various insurance plans available and making an informed choice.</p>
                                </div>
                            </div></div></div>
                        </div>
                    </section>
